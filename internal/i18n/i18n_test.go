...
func TestResolve(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "C locale overrides Chinese LANG", env: map[string]string{"LC_ALL": "C", "LANG": "zh_CN.UTF-8"}, want: LangEn},
		{name: "English LC_ALL overrides Chinese LANG", env: map[string]string{"LC_ALL": "en_US.UTF-8", "LANG": "zh_CN.UTF-8"}, want: LangEn},
		{name: "Chinese LC_ALL overrides English LANG", env: map[string]string{"LC_ALL": "zh_CN.UTF-8", "LANG": "en_US.UTF-8"}, want: LangZh},
