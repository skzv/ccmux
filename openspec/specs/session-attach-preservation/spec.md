# session-attach-preservation Specification

## Purpose
Ensure ccmux can open newly created tmux sessions without disrupting
other clients, while preserving configurable attach behavior for
explicit existing-session attaches.
