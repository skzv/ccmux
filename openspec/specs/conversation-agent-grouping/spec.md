# conversation-agent-grouping Specification

## Purpose
Define how the Conversations TUI projects the flat conversation list into
known-agent views with agent-level navigation and section-scoped actions.
## Requirements
