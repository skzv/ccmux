# agent-install-resolution Specification

## Purpose
Ensure ccmux consistently detects, records, and uses the agent executable
selected during setup so sessions launch the intended local installation.
